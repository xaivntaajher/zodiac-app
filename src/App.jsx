      ...
      <div className="bg-gray-200 p-6 rounded shadow w-full max-w-sm">
        ...
        <div className="flex justify-center gap-4 mb-4">
          <button
            ...
            className="appearance-none bg-blue-500 text-inherit py-1 px-3 rounded hover:bg-blue-600"
          >
            {showList === "western"
          ...
          <button
            ...
            className="appearance-none bg-green-500 text-inherit py-1 px-3 rounded hover:bg-green-600"
          >
            {showList === "chinese"
        ...
        >
          <select
            ...
            className="text-inherit border p-3 rounded"
